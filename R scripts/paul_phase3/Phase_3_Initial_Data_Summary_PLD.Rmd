...
Of the `r format(n_obs_final, big.mark = ",")` observations, **`r format(card_summary[2], big.mark = ",")`** had their vaccination card and **`r format(card_summary[1], big.mark = ",")`** did not have their vaccination card. `r format(card_summary[3], big.mark = ",")` of the observations were missing this information.
